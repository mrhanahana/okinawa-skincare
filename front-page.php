...
<div id="news_header">
  ...
  <div id="news_header_inner">
    ...
    <?php if($catch || $desc){ ?>
    <?php if($catch){ ?>
    <h2 id="news_headline_top" class="catch<?php if($catch_mobile) { echo ' has_mobile_word'; }; ?>"<?php if($catch_mobile) { echo ' data-label="' . nl2br(esc_html($catch_mobile)) . '"'; }; ?>><span class="rich_font"><?php echo wp_kses_post(nl2br($catch)); ?></span>
      <?php }; ?>
      <?php if($desc){ ?>
      <span class="desc<?php if($desc_mobile) { echo ' has_mobile_word'; }; ?>"<?php if($desc_mobile) { echo ' data-label="' . nl2br(esc_html($desc_mobile)) . '"'; }; ?>><?php echo nl2br(esc_html($desc)); ?></span></h2>
    <?php }; ?>
    <?php }; ?>
    <div id="news_header_list">
      <?php if($catch || $desc){ ?>
      <?php if($catch){ ?>
      <h2 class="catch<?php if($catch_mobile) { echo ' has_mobile_word'; }; ?>"<?php if($catch_mobile) { echo ' data-label="' . nl2br(esc_html($catch_mobile)) . '"'; }; ?>><span class="rich_font"><?php echo wp_kses_post(nl2br($catch)); ?></span>
        <?php }; ?>
        <?php if($desc){ ?>
        <span class="desc<?php if($desc_mobile) { echo ' has_mobile_word'; }; ?>"<?php if($desc_mobile) { echo ' data-label="' . nl2br(esc_html($desc_mobile)) . '"'; }; ?>><?php echo nl2br(esc_html($desc)); ?></span></h2>
      <?php }; ?>
...
<div id="index_clinic" class="index_content">
  ...
  <div class="index_cb_catch">
    ...
    <?php }; ?>
    <?php if($catch){ ?>
    <h2 class="catch rich_font<?php if($catch_mobile) { echo ' has_mobile_word'; }; ?>"<?php if($catch_mobile) { echo ' data-label="' . nl2br(esc_html($catch_mobile)) . '"'; }; ?>><span><?php echo wp_kses_post(nl2br($catch)); ?></span></h2>
    <?php }; ?>
    <?php if($desc){ ?>
    <p class="desc<?php if($desc_mobile) { echo ' has_mobile_word'; }; ?>"<?php if($desc_mobile) { echo ' data-label="' . nl2br(esc_html($desc_mobile)) . '"'; }; ?>><span><?php echo nl2br(esc_html($desc)); ?></span></p>
    <?php }; ?>
  </div>
  <?php }; ?>
...
<div id="index_banner" class="index_content clearfix">
  ...
  <div class="box box<?php echo $i; ?>">
    ...
    <?php }; ?>
    <img class="image normal_image object_fit" src="<?php echo esc_attr($image[0]); ?>"> </a>
    <?php }; ?>
  </div>
  <?php }; endfor; ?>
</div>
...
$count = 1;
?>
<div id="campaign_list" class="clearfix <?php echo esc_attr($layout_type); if($change_size == 0) { echo ' same_size'; }; ?>">
<?php
...
<article class="item clearfix <?php if($i <= $change_size){ echo 'large'; } else { if($count % 3 == 0) { echo ' third'; }; $count++; }; ?>">
<?php } else { ?>
<article class="item clearfix <?php if($i > $change_size){ echo 'large'; if($count % 2 == 0) { echo ' even'; }; $count++; }; ?>">
  <?php }; ?>
  ...
  <img class="image normal_image object_fit" src="<?php echo esc_attr($image[0]); ?>"> </a> </article>
<?php $i++; endwhile; ?>
</div>
<!-- END .post_list -->
