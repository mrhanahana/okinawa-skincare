...
<header id="header">
  <div id="header_top">
		<h1 class="title"><div class="inner"><?php echo esc_html( wp_get_document_title() ); ?></div></h1>
  ...
  <div class="header_slider_wrap_inner">
    ...
    <div id="header_slider"<?php if($options['header_content_type'] == 'type4') { echo ' class="header_para_slider" data-slider-time="'.esc_attr($options['header_para_time']).'"'; } ?>>
      ...
      <div class="item item<?php echo $i; ?> slick-slide animation_<?php echo esc_attr($animation_type); ?>">
        ...
        <a href = "<?php // echo esc_url($url); ?>" <?php // if($target == 1) { echo ' target="_blank"'; }; ?>>
        <?php // }; ?>
        <img src="<?php // echo esc_attr($image_url); ?>" class="pc" /> <img src="<?php // echo esc_attr($image_mobile_url); ?>" class="sp" />
        <?php // if ( ( $show_button == 0 ) && $url ) { ?>
        </a>
        <?php // }; ?>
				-->
