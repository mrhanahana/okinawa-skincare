jQuery(document).ready(function ($) {
  ...
  $("[data-megamenu]").each(function () {
    ...
    var hide_sub_menu_interval = function () {
      ...
      hide_sub_menu_timer = setInterval(function () {
        if (
          !$(mega_menu_button).is(":hover") &&
          !$(sub_menu_wrap).is(":hover")
        ) {
  ...
  function initDrawerMenu() {
    ...
    var mobile_global_menu = $("#mobile_menu #global_menu");

    // 子メニュー開閉ボタン
    mobile_global_menu.find(".child_menu_button").remove();
    ...
    mobile_global_menu
      ...
      .on("click", function () {
        ...
        if (parent.hasClass("open")) {
          ...
          parent.find(">ul:not(:animated)").slideUp("fast");
        } else {
          parent.addClass("open");
          parent.find(">ul:not(:animated)").slideDown("fast");
        }
    ...
    // 二重登録を防ぐ
    menu_button.off("click.drawer");

    // ハンバーガーメニュー
    menu_button.on("click.drawer", function (e) {
      e.preventDefault();
      e.stopPropagation();
  ...
  function checkBreakPoint(mql) {
    if (mql.matches) {
      ...
      // ドロワー側のメニュー
      var mobile_global_menu = $("#mobile_menu #drawer_menu");
      ...
      $("#global_menu li:not(.megamenu_parent)").hover(
        function () {
          $(">ul:not(:animated)", this).slideDown("fast");
          $(this).addClass("active");
