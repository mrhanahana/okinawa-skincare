<?php
/*
Template Name:page noside full width
*/
...
<?php }; ?>
 <div id="page_header_inner">
  <div id="page_header_catch">
   <div class="catch rich_font" style="color:<?php echo esc_html($page_title_color); ?>;"><?php the_title(); ?></div>
  </div>
 </div>
...
<div id="one_col" class="fullwidth">
